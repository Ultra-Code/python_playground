...
fn print_line():
    var long_text = "This is a long line of text that is a lot easier to read if it is broken up across two lines instead of one long line."
...
fn min_(
    a: Int, b: Int, /, *c: Int
) -> Variant[Tuple[Int, VariadicList[Int]], Int]:
